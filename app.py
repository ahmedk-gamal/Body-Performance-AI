...
st.markdown("---")
    ...
    # تعريف الجداول التدريبية
    workout_plans = {
        0: { # فئة A - مستوى متقدم
            "السبت": "تمارين دفع (Push) + صدر + أكتاف + تراي",
            "الأحد": "تمارين سحب (Pull) + ظهر + باي",
            "الاثنين": "رجل كاملة + سمانة",
            "الثلاثاء": "راحة إيجابية (يوجا أو مشي خفيف)",
            "الأربعاء": "HIIT Cardio + تمارين بطن مكثفة",
            "الخميس": "فول بادي (Full Body) لرفع القوة البدنية",
            "الجمعة": "راحة تامة"
        },
        1: { # فئة B - مستوى فوق المتوسط
            "السبت": "عضلة كبيرة (صدر) + عضلة صغيرة (تراي)",
            "الأحد": "عضلة كبيرة (ظهر) + عضلة صغيرة (باي)",
            "الاثنين": "راحة",
    ...
    # عرض الجدول باستخدام Tabs لشكل جمالي
